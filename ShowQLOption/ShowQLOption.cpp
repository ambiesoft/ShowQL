...
// ShowQLOption.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CShowQLOptionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CShowQLOptionApp construction

CShowQLOptionApp::CShowQLOptionApp()
{
...
// The one and only CShowQLOptionApp object

CShowQLOptionApp theApp;


// CShowQLOptionApp initialization
